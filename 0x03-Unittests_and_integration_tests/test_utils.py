...
class TestAccessNestedMap(unittest.TestCase):
    ...
    def test_access_nested_map_exception(self, nested_map: dict, path: tuple, expected_message: str) -> None:
        """
        Test that access_nested_map raises a KeyError with the correct message for invalid paths.
        """
...
class TestGetJson(unittest.TestCase):
    """
    Defines test cases for the get_json function.
    """
    ...
    def test_get_json(self, test_url: str, test_payload: dict, mock_get: Mock) -> None:
        """
        Test that get_json returns the correct payload and requests.get is called correctly.
        """
        mock_response = Mock()
